...
var morph = Object(animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
  targets: '.morph-path',
  d: [{
    value: shapes[0].d
  }, {
  ...
  complete: function complete(anim) {
    ...
    if (anim.reversed) {
      ...
      document.querySelectorAll(".navigation nav ul li").forEach(function (el) {
...
document.querySelector(".im-a-hamburger").addEventListener("click", function (e) {
  if (!document.querySelector(".navigation").classList.contains("open")) {
    document.querySelector(".im-a-hamburger").classList.toggle("hidden");
    document.querySelector("#close").style.display = 'block';
    document.querySelector(".navigation").classList.toggle("open");
    morph.play();
  }
});
document.querySelector(".checkmark").addEventListener("click", function (e) {
  if (document.querySelector(".navigation").classList.contains("open")) {
    document.querySelector(".im-a-hamburger").classList.toggle("hidden");
...
__webpack_require__(/*! C:\Users\Corra\Desktop\myPortfolio\src\js\app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Corra\Desktop\myPortfolio\src\scss\app.scss */"./src/scss/app.scss");
